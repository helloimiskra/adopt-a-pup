...
shelter_admin_two = User.create(first_name: 'Hyori', last_name: 'Lee', username: 'leehyori', password: 'password', email: 'hyori@hyori.com', shelter_admin: true)
...
pet_two = Pet.create(name: 'Lovely', pet_type: 'Dog', breed: 'Pembroke Welsh Corgi', description: 'Surrendered by previous owner due to poor health. Big cuddle-bug.', shelter_id: 1, user_id: 1, adopted: false)
pet_three = Pet.create(name: 'Coco', pet_type: 'Cat', breed: 'Persian', description: 'Found crying for mom. Needs foster or adopter immediately.', shelter_id: 2, user_id: 3, adopted: false)