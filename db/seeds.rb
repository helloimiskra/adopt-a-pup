...
shelter_one = Shelter.create(name: "Needs Love", address: "Gangnam Station Exit 2", email: 'needslove@lovepets.com')
shelter_two = Shelter.create(name: "Karma", address: 'Yongin', email: 'karma@karma.com')
